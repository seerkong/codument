...
describe('旧 plan.xml 兼容性', () => {
  const archive1 = path.resolve('codument/archive/2026-01-11-create-codument-prompts-20260101/plan.xml');
  const archive2 = path.resolve('codument/archive/2026-01-22-refactor-prompt-question-protocols/plan.xml');
