...
按 `std/protocols/decision-tree.md` 处理 severity、evidence 和当前 decision frontier。MissionObserver 先查证，MissionPlanner 生成 frontier，MissionReconciler 判断阻塞关系，MissionApplier 只在当前模式允许时提问；`auto` 直接记录假设并继续。
