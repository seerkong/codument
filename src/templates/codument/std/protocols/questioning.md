...
Decision-tree structure, storage, and frontier handling are owned by `std/protocols/decision-tree.md`. This file only defines the question budget and interaction forms.
