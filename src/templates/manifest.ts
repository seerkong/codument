...
import f24 from './codument/std/operations/discuss.md' with { type: 'text' };
import f25 from './codument/std/operations/docs-bootstrap.md' with { type: 'text' };
import f26 from './codument/std/operations/gap-loop.md' with { type: 'text' };
import f27 from './codument/std/operations/impl-mission.md' with { type: 'text' };
...
import f44 from './codument/std/spec/engineering-delta.md' with { type: 'text' };
import f45 from './codument/std/spec/engineering-node-schema.md' with { type: 'text' };
import f46 from './codument/std/spec/engineering-registry.md' with { type: 'text' };
import f47 from './codument/std/spec/flow-notation.md' with { type: 'text' };
import f48 from './codument/std/spec/folder-manifest.md' with { type: 'text' };
import f49 from './codument/std/spec/mission-xml-spec.md' with { type: 'text' };
import f50 from './codument/std/spec/modeling-delta.md' with { type: 'text' };
import f51 from './codument/std/spec/modeling-node-schema.md' with { type: 'text' };
import f52 from './codument/std/spec/modeling-registry.md' with { type: 'text' };
import f53 from './codument/std/spec/track-xml-spec.md' with { type: 'text' };
import f54 from './codument/std/spec/xnl-format.md' with { type: 'text' };
import f55 from './codument/workflows/README.md' with { type: 'text' };
import f56 from './skills/README.md' with { type: 'text' };
import f57 from './skills/codument-archive-mission/SKILL.md' with { type: 'text' };
import f58 from './skills/codument-archive-track/SKILL.md' with { type: 'text' };
import f59 from './skills/codument-archive/SKILL.md' with { type: 'text' };
import f60 from './skills/codument-artifact-sync/SKILL.md' with { type: 'text' };
import f61 from './skills/codument-code-quality-score/SKILL.md' with { type: 'text' };
import f62 from './skills/codument-decision-tree/SKILL.md' with { type: 'text' };
...
import f69 from './skills/codument-migrate/SKILL.md' with { type: 'text' };
import f70 from './skills/codument-modeling-engineering-e2e/SKILL.md' with { type: 'text' };
import f71 from './skills/codument-plan-mission/SKILL.md' with { type: 'text' };
import f72 from './skills/codument-plan-track-wave/SKILL.md' with { type: 'text' };
import f73 from './skills/codument-plan-track/SKILL.md' with { type: 'text' };
import f74 from './skills/codument-revise-track/SKILL.md' with { type: 'text' };
import f75 from './skills/codument-track/SKILL.md' with { type: 'text' };
import f76 from './skills/codument-validate/SKILL.md' with { type: 'text' };
import f77 from './skills/codument-verify/SKILL.md' with { type: 'text' };
...
export const TEMPLATE_FILES: TemplateFile[] = [
  ...
  { path: "codument/std/operations/discuss.md", content: f24 },
  { path: "codument/std/operations/docs-bootstrap.md", content: f25 },
  { path: "codument/std/operations/gap-loop.md", content: f26 },
  { path: "codument/std/operations/impl-mission.md", content: f27 },
  ...
  { path: "codument/std/spec/engineering-delta.md", content: f44 },
  { path: "codument/std/spec/engineering-node-schema.md", content: f45 },
  { path: "codument/std/spec/engineering-registry.md", content: f46 },
  { path: "codument/std/spec/flow-notation.md", content: f47 },
  { path: "codument/std/spec/folder-manifest.md", content: f48 },
  { path: "codument/std/spec/mission-xml-spec.md", content: f49 },
  { path: "codument/std/spec/modeling-delta.md", content: f50 },
  { path: "codument/std/spec/modeling-node-schema.md", content: f51 },
  { path: "codument/std/spec/modeling-registry.md", content: f52 },
  { path: "codument/std/spec/track-xml-spec.md", content: f53 },
  { path: "codument/std/spec/xnl-format.md", content: f54 },
  { path: "codument/workflows/README.md", content: f55 },
  { path: "skills/README.md", content: f56 },
  { path: "skills/codument-archive-mission/SKILL.md", content: f57 },
  { path: "skills/codument-archive-track/SKILL.md", content: f58 },
  { path: "skills/codument-archive/SKILL.md", content: f59 },
  { path: "skills/codument-artifact-sync/SKILL.md", content: f60 },
  { path: "skills/codument-code-quality-score/SKILL.md", content: f61 },
  { path: "skills/codument-decision-tree/SKILL.md", content: f62 },
  ...
  { path: "skills/codument-migrate/SKILL.md", content: f69 },
  { path: "skills/codument-modeling-engineering-e2e/SKILL.md", content: f70 },
  { path: "skills/codument-plan-mission/SKILL.md", content: f71 },
  { path: "skills/codument-plan-track-wave/SKILL.md", content: f72 },
  { path: "skills/codument-plan-track/SKILL.md", content: f73 },
  { path: "skills/codument-revise-track/SKILL.md", content: f74 },
  { path: "skills/codument-track/SKILL.md", content: f75 },
  { path: "skills/codument-validate/SKILL.md", content: f76 },
  { path: "skills/codument-verify/SKILL.md", content: f77 },
];
