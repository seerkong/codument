...
import f29 from './codument/std/operations/init.md' with { type: 'text' };
import f30 from './codument/std/operations/migrate.md' with { type: 'text' };
import f31 from './codument/std/operations/plan-mission.md' with { type: 'text' };
import f32 from './codument/std/operations/plan-track-wave.md' with { type: 'text' };
import f33 from './codument/std/operations/plan-track.md' with { type: 'text' };
import f34 from './codument/std/operations/revise-track.md' with { type: 'text' };
import f35 from './codument/std/operations/status.md' with { type: 'text' };
...
import f65 from './skills/codument-discuss/SKILL.md' with { type: 'text' };
import f66 from './skills/codument-docs-bootstrap/SKILL.md' with { type: 'text' };
import f67 from './skills/codument-gap-loop/SKILL.md' with { type: 'text' };
import f68 from './skills/codument-impl-mission/SKILL.md' with { type: 'text' };
import f69 from './skills/codument-impl-track/SKILL.md' with { type: 'text' };
import f70 from './skills/codument-implement/SKILL.md' with { type: 'text' };
import f71 from './skills/codument-init/SKILL.md' with { type: 'text' };
import f72 from './skills/codument-migrate/SKILL.md' with { type: 'text' };
import f73 from './skills/codument-modeling-engineering-e2e/SKILL.md' with { type: 'text' };
import f74 from './skills/codument-plan-mission/SKILL.md' with { type: 'text' };
import f75 from './skills/codument-plan-track-wave/SKILL.md' with { type: 'text' };
import f76 from './skills/codument-plan-track/SKILL.md' with { type: 'text' };
import f77 from './skills/codument-revise-track/SKILL.md' with { type: 'text' };
import f78 from './skills/codument-status/SKILL.md' with { type: 'text' };
...
export const TEMPLATE_FILES: TemplateFile[] = [
  ...
  { path: "codument/std/operations/init.md", content: f29 },
  { path: "codument/std/operations/migrate.md", content: f30 },
  { path: "codument/std/operations/plan-mission.md", content: f31 },
  { path: "codument/std/operations/plan-track-wave.md", content: f32 },
  { path: "codument/std/operations/plan-track.md", content: f33 },
  { path: "codument/std/operations/revise-track.md", content: f34 },
  { path: "codument/std/operations/status.md", content: f35 },
  ...
  { path: "skills/codument-discuss/SKILL.md", content: f65 },
  { path: "skills/codument-docs-bootstrap/SKILL.md", content: f66 },
  { path: "skills/codument-gap-loop/SKILL.md", content: f67 },
  { path: "skills/codument-impl-mission/SKILL.md", content: f68 },
  { path: "skills/codument-impl-track/SKILL.md", content: f69 },
  { path: "skills/codument-implement/SKILL.md", content: f70 },
  { path: "skills/codument-init/SKILL.md", content: f71 },
  { path: "skills/codument-migrate/SKILL.md", content: f72 },
  { path: "skills/codument-modeling-engineering-e2e/SKILL.md", content: f73 },
  { path: "skills/codument-plan-mission/SKILL.md", content: f74 },
  { path: "skills/codument-plan-track-wave/SKILL.md", content: f75 },
  { path: "skills/codument-plan-track/SKILL.md", content: f76 },
  { path: "skills/codument-revise-track/SKILL.md", content: f77 },
  { path: "skills/codument-status/SKILL.md", content: f78 },
